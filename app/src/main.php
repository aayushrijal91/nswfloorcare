        ...
        <div class="row justify-content-center">
            <div class="col-12 col-xl-10">
                <div class="row no-gutters justify-content-between align-items-end">
                    ...
                    <div class="col-lg-5">
                        <div class="text-white letter-spacing-n02 fw-500 h5 line-height-1"><span class="fw-700">At NSW Floor Care</span> we service<br> residential, commercial and all strata.</div>
